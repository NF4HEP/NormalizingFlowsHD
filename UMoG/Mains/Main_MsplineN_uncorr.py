...
mother_output_dir='../results/MsplineN_uncorr/'
try:
                                                ...
                                                for corr in corr_uncorr_list:
                                                    ...
                                                    try:
                                                        if to_run:
                                                            ...
                                                            rot = MixtureDistributions.rot_matrix(X_data_train)
                                                            X_data_train = MixtureDistributions.transform_data(X_data_train,rot)
                                                            X_data_test = MixtureDistributions.transform_data(X_data_test,rot)
                                                            if corr == "corr":
                                                                V = None
                                                            elif corr == "uncorr":
