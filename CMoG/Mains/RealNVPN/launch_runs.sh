...
declare -a visible_devices_list=("2" "3")

# Declare an array of run numbers
declare -a run_numbers=("3")
...
do
    ...
    do
        ...
        echo "Script string: nohup python c_Main_RealNVPN.py --visible_devices $vis_dev >> ../../Outputs/RealNVPN/run_gpu_${vis_dev}_replica_${run_num}.out 2>&1 &"

        nohup python c_Main_RealNVPN.py --visible_devices $vis_dev >> ../../Outputs/RealNVPN/run_gpu_${vis_dev}_replica_${run_num}.out 2>&1 &
