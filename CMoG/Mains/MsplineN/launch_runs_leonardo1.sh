...
do
    ...
    do
        ...
        nohup python c_Main_MsplineN.py --visible_devices $vis_dev >> /leonardo/home/userexternal/rtorre00/git/GitHub/NormalizingFlows/NF4HEP/NormalizingFlowsHD/CMoG/Outputs/MsplineN/run_gpu_${vis_dev}_replica_${run_num}.out 2>&1 &
