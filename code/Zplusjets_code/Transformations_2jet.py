...
def CoordTransforms(events):
    ...
    spher_all=np.concatenate((spher_mu1,spher_mu2,spher_jet1,spher_jet2),axis=1)
...
def BackToCartesian(LHCcoord):
    ...
    coord_all=np.concatenate((coord_mu1,coord_mu2,coord_jet1,coord_jet2),axis=1)
...
def SaveCoord(spher_all):
    ...
    file = h5py.File('LHCCoordZjet2.h5', 'w')
    file.create_dataset('LHCCoordZjet2', data=spher_all)
    file.close()
    return
