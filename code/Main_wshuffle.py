...
mother_output_dir='../results/test_cspline_binshuffle_nolinear_act_6/'
try:
                                                    ...
                                                    try:
                                                        if to_run:
                                                            ...
                                                            print("===========\nRunning",run_number,"/",n_runs,"with hyperparameters:\n",
                                                                  ...
                                                                  "epocs_input=",epochs,
                                                                  "\n===========\n")
                                                            bijector=Bijectors.ChooseBijector(bijector_name,ndims,spline_knots,nbijectors,range_min,hidden_layers,activation,regulariser,eps_regulariser,perm_style,shuffle)
